...
const PRESETS = {
    frosted_glass: {
        ...
        border_radius_px: 14,
        blur_px: 20,
        swatch: 'linear-gradient(135deg, #3498db, #1a1a2e)',
    },
    neon_glow: {
        label: 'Neon Glow',
        accent_color: '#00e5ff',
        ...
        border_radius_px: 14,
        blur_px: 12,
        swatch: 'linear-gradient(135deg, #00e5ff, #0a0a1a)',
    },
    vinyl: {
        label: 'Vinyl',
        accent_color: '#d4a057',
        ...
        border_radius_px: 14,
        blur_px: 10,
        swatch: 'linear-gradient(135deg, #d4a057, #1e140f)',
    },
    minimal: {
        label: 'Minimal',
        accent_color: '#ffffff',
    ...
    spotify: {
        ...
        border_radius_px: 8,
        blur_px: 8,
        swatch: 'linear-gradient(135deg, #1DB954, #121212)',
    },
    cyberpunk: {
        label: 'Cyberpunk',
        accent_color: '#ff2d95',
        background_color: '#0a0214',
        text_color: '#f0e6ff',
        border_radius_px: 2,
        blur_px: 6,
        swatch: 'linear-gradient(135deg, #ff2d95, #00ffff)',
    },
    pastel_dream: {
        label: 'Pastel Dream',
        accent_color: '#a78bfa',
        background_color: '#1f1635',
        text_color: '#fdf4ff',
        border_radius_px: 20,
        blur_px: 24,
        swatch: 'linear-gradient(135deg, #a78bfa, #f472b6)',
    },
    gradient_wave: {
        label: 'Gradient Wave',
        accent_color: '#818cf8',
